...
export function DeactivatedIMEIPage({ onBack, onIMEIClick }: DeactivatedIMEIPageProps) {
  ...
  const filteredSummaries = useMemo(() => {
    let filtered = [...deactivatedSummaries];
            ...
            <div className="flex items-center gap-2 mb-4">
              ...
              {hasActiveFilters && (
                <Badge variant="secondary" className="text-xs ml-auto">
                  {filteredSummaries.length} of {deactivatedSummaries.length}
                </Badge>
              )}
            </div>
                  ...
                  {filteredSummaries.length === 0 ? (
                    <TableRow>
                      <TableCell colSpan={8} className="text-center text-muted-foreground py-8">
                        {hasActiveFilters ? 'No matching deactivated IMEIs found' : 'No deactivated IMEIs found'}
                      </TableCell>
                    </TableRow>
                  ) : (
